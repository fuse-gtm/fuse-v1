  ...
  return (
    <BaseEmail width={333} locale={locale}>
      ...
      <MainText>
        ...
        <br />
        <Trans
          id="If you wish to continue using Fuse, please update your subscription within the next {remainingDays} {dayOrDays}."
          values={{ remainingDays, dayOrDays }}
        />
      </MainText>
      <br />
      <CallToAction
        href="https://app.fusegtm.com/settings/billing"
