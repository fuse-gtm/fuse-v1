import { type ExtractSerializedRelationProperties } from './ExtractSerializedRelationProperties.type';
import { type IsSerializedRelation } from './IsSerializedRelation.type';
import { type RemoveSuffix } from './RemoveSuffix.type';
