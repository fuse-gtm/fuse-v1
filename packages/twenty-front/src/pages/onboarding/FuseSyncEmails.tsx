...
export const FuseSyncEmails = () => {
  ...
  return (
    <FuseAuthLayout
      title={t`Emails and Calendar`}
      subtitle={t`Sync your Emails and Calendar with Fuse. Choose your privacy settings.`}
      stepNumber={3}
      totalSteps={5}
      footer={<FooterNote />}
      previewContent={<FuseOnboardingPreview variant="sync" />}
    >
