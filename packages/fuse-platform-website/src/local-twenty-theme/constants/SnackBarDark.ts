import { BACKGROUND_DARK } from '@/local-twenty-theme/constants/BackgroundDark';
import { FONT_DARK } from '@/local-twenty-theme/constants/FontDark';
import { MAIN_COLORS_DARK } from '@/local-twenty-theme/constants/MainColorsDark';
