import { BLUR_LIGHT } from '@/local-twenty-theme/constants/BlurLight';
import { COLOR_LIGHT } from '@/local-twenty-theme/constants/ColorsLight';
import { GRAY_SCALE_LIGHT } from '@/local-twenty-theme/constants/GrayScaleLight';
import { ILLUSTRATION_ICON_LIGHT } from '@/local-twenty-theme/constants/IllustrationIconLight';
import { SNACK_BAR_LIGHT } from '@/local-twenty-theme/constants/SnackBarLight';
