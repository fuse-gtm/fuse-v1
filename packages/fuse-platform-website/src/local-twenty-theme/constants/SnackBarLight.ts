import { BACKGROUND_LIGHT } from '@/local-twenty-theme/constants/BackgroundLight';
import { FONT_LIGHT } from '@/local-twenty-theme/constants/FontLight';
import { MAIN_COLORS_LIGHT } from '@/local-twenty-theme/constants/MainColorsLight';
