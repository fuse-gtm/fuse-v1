...
| # | SHA | PR | Title | Verdict | Wave | Reason (reject/defer only) | New SHA on main |
|---|-----|----|-------|---------|------|----------------------------|---|
...
| 4 | `0223975bbd` | #18318 | Harden GitHub Actions: fix injections, isolate privileged operations to ci-privileged repo (#18318) | ACCEPT | 2A-security |  | `dd7338f8ed` |
...
| 48 | `80d054563e` | #18225 | followup: centralize widget common properties and add widget bulk update integration tests (#18225) | ACCEPT | 2B-backend |  | `01e8245e47` |
...
| 95 | `e5e3132ddd` | #18422 | Add ESLint rules to disallow jotaiStore and direct atomFamily usage in selectors (#18422) | ACCEPT | 2C-frontend |  | `e07949bf51` |
| 96 | `c53a13417e` | #18430 | Remove all styled(Component) patterns in favor of parent wrappers and props (#18430) | ACCEPT | 2C-frontend | reclassified from 2D (regex false positive — pure styling refactor on role-admin screens, not a RBAC change) | `242feb44df` |
...
| 113 | `aa062644c8` | #18367 | Fixed scrollbar height issue in Kanban view and adjusted the calendar view to adjust with the new change (#18367) | ACCEPT | 2C-frontend |  | `45bb8a5c88` |
...
| 118 | `a79b816117` | #18420 | Allow users to set where new fields must be created in a record page layout (#18420) | ACCEPT | 2C-frontend |  | `1c0c5967a7` |
...
| 124 | `cac4999e9f` | #18107 | fix: handle Escape in date/datetime pickers and remove ValidationStep any (#18107) | ACCEPT | 2C-frontend |  | `c76db3ce33` |
...
| 136 | `a9696705c1` | #18471 | Make all widgets of record page layouts non-editable except Fields widgets (#18471) | ACCEPT | 2C-frontend |  | `87dc7836e9` |
...
| 237 | `0379aea0b1` | #18614 | fix: split tsvector migration, add configurable DB timeout, reorder 1.19 commands (#18614) | ACCEPT | 2B-backend |  | `0aa3008b72` |
...
| 260 | `7a3540788a` | #18647 | feat: uniformize metadata store with flat types, SSE alignment, presentation endpoint & localStorage (#18647) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=1238 vs server lines=207 | `3edcef5d10` |
...
| 262 | `ba9aa41bba` | #18651 | refactor: metadata store cleanup, SSE unification, mock metadata loading & login redirect fix (#18651) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=6479 vs server lines=272 | `6c0293a21f` |
...
| 286 | `1bb642d7cd` | #18687 | refactor: remove ProcessedNavigationMenuItem, derive display fields at point of use (#18687) | ACCEPT | 2C-frontend |  | `507f6e2e26` |
...
| 300 | `9f7c29bce8` | #18697 | refactor(twenty-front): unify Favorites and Workspace navigation menu item code (#18697) | ACCEPT | 2C-frontend |  | `98eba76af0` |
...
| 335 | `a9f8a7e1fa` | #18760 | Fix: prevent record navigation when clicking Remove from favorite in nav sidebar (#18760) | ACCEPT | 2C-frontend |  | `f8ca7ac988` |
...
| 345 | `66be7c3ef4` | #18796 | fix: autogrow input sizing + surface nested error details in upgrade command (#18796) | ACCEPT | 2B-backend | mixed server/frontend — server lines=53 vs front lines=3 | `2708e12f08` |
...
| 354 | `3d49c21b51` | #18803 | fix: decouple viewPicker favorite detection from sorted navigation menu items (#18803) | ACCEPT | 2C-frontend |  | `2b3d58864f` |
...
| 356 | `9cb21e71fa` | #18787 | feat: secure and user-scope metadata resolvers for messaging infrastructure (#18787) | ACCEPT | 2B-backend | mixed server/frontend — server lines=2745 vs front lines=1324 | `b0e40801ab` |
...
| 369 | `03a2abb305` | #18824 | fix: board view loads all records instead of showing skeleton placeholders (#18824) | ACCEPT | 2C-frontend |  | `c96811db8c` |
...
| 427 | `611947e031` | #18901 | fix: metadata store lifecycle during sign-in, sign-out, and locale change (#18901) | ACCEPT | 2C-frontend |  | `3eccc18286` |
...
| 437 | `cac92bffe3` | #18923 | Refactor backfill-command-menu-items to use a single validateBuildAndRun call (#18923) | ACCEPT | 2B-backend |  | `059a6554b0` |
...
| 446 | `d5b41b2801` | #18927 | Unify auth context → role permission config resolution into a single pure utility (#18927) | ACCEPT | 2B-backend |  | `38332b03f5` |
...
| 452 | `b642d1b114` | #18867 | Animate the sidebar when opening/closing an element in the "opened" section (#18867) | ACCEPT | 2C-frontend |  | `29a61de660` |
...
| 468 | `13ea3ec75c` | #18957 | Split command menu items backfill into separate migration runs per application (#18957) | ACCEPT | 2B-backend |  | `736e9f54b0` |
...
| 477 | `511d1bd7ab` | #18966 | Fix SSE event stream errors when impersonating users with limited permissions (#18966) | ACCEPT | 2C-frontend |  | `c815ac3558` |
...
| 488 | `4985270e69` | #18876 | [AI] Refactor settings search to use SearchInput and restructure Skills tab (#18876) | ACCEPT | 2C-frontend |  | `3a0542d6c0` |
...
| 507 | `b171a23216` | #19003 | [AI] replace custom styles with MenuItem and SidePanelGroup in AI agent persmissions tab (#19003) | ACCEPT | 2C-frontend |  | `26c760d686` |
...
| 537 | `fb21f3ccf5` | #19041 | fix: resolve availabilityObjectMetadataUniversalIdentifier in backfill command (#19041) | ACCEPT | 2B-backend |  | `b7725c53d9` |
...
| 554 | `a3f468ef98` | #19082 | chore: remove IS_ROW_LEVEL_PERMISSION_PREDICATES_ENABLED and IS_DATE_TIME_WHOLE_DAY_FILTER_ENABLED feature flags (#19082) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `a8e7adf6dc` |
...
| 571 | `08b041633a` | #19083 | chore: remove 1-19 upgrade commands and navigation menu item feature flags (#19083) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `7ba6beca58` |
...
| 606 | `c23961fa81` | #19075 | Fix navbar object color not updating immediately when changed in edit mode (#19075) | ACCEPT | 2C-frontend |  | `cef4bf236d` |
...
| 618 | `9054d3aef6` | #19211 | [COMMAND MENU ITEMS] Resolve object metadata label in dynamic command menu item label (#19211) | ACCEPT | 2C-frontend |  | `3bf49dd49b` |
| 619 | `291792f864` | #19208 | Repair Edit Layout command menu item and add a button in settings to start edition too (#19208) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=269 vs server lines=102 | `8ad914f11e` |
...
| 650 | `223943550c` | #19235 | [AI] Unify code-interpreter streaming rendering and fix assistant width jitter (#19235) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=119 vs server lines=38 | `99e0b6a1e5` |
...
| 670 | `aadbf67ec8` | #19264 | [CommandMenu] Disable record selection dropdown on record pages in command menu editor (#19264) | ACCEPT | 2C-frontend |  | `03c385c738` |
...
| 674 | `c1e4756f9c` | #19200 | Add is active to overridable entities and deactivation logic for page layouts (#19200) | ACCEPT | 2B-backend |  | `e3ac1b1008` |
...
| 713 | `563e27831b` | #19321 | Clean up tool output architecture: remove wrappers, enforce ToolOutput everywhere (#19321) | ACCEPT | 2B-backend | mixed server/frontend — server lines=609 vs front lines=81 | `3f2c9e56f7` |
...
| 738 | `7053e1bbc5` | #19375 | fix: bypass permission checks in 1.21 backfill-message-thread-subject command (#19375) | ACCEPT | 2B-backend |  | `32e2eb8ac9` |
...
| 759 | `96a242eb7d` | #19394 | fix(messaging): create messageThread.subject field metadata + column in 1-21 backfill (#19394) | ACCEPT | 2B-backend |  | `bd86a6e4a8` |
...
| 764 | `1f3965e5f8` | #19310 | Add Manage and Placement sections in widget side panel page for record page layouts (#19310) | ACCEPT | 2C-frontend |  | `dff96af0f2` |
...
| 781 | `15eb3e7edc` | #19409 | feat(sdk): use config file as single source of truth, remove env var fallbacks (#19409) | ACCEPT | 2A-security |  | `764f29708d` |
| 782 | `c91d642f29` | #19417 | App feedbacks front (#19417) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=63 vs server lines=3 | `6a706a6d6c` |
| 783 | `20adb86917` | #19402 | fix: IMAP skip no-select flag folders properly (#19402) | ACCEPT | 2B-backend |  | `76b88c9d60` |
...
| 786 | `b3d46b0fa3` | #19420 | feat: Add support for CLF currency code (#19420) | ACCEPT | 2C-frontend |  | `1d92ed592d` |
| 787 | `8026451220` | #19426 | chore: sync AI model catalog from models.dev (#19426) | ACCEPT | 2B-backend |  | `34c833545e` |
| 788 | `90de1d4a34` | #19413 | Add twenty sync command (#19413) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `d6a998f01d` |
| 789 | `8090fa4364` | #19437 | i18n - docs translations (#19437) | ACCEPT | i18n-bulk |  |  |
| 790 | `e9310555fb` | #19436 | Fix tab selection in layout edit mode (#19436) | ACCEPT | 2C-frontend |  | `e13f25734e` |
| 791 | `9d96e529c8` | #19440 | Fix last widget bottom bar inconsistencies (#19440) | ACCEPT | 2C-frontend |  | `1123ff596a` |
| 792 | `9a58f3d459` | #19428 | Add a lock on function creation (#19428) | ACCEPT | 2B-backend |  | `9888d7fc08` |
| 793 | `8aa208fc93` | #19433 | Fix overridable entities logic for SSE (#19433) | ACCEPT | 2B-backend | mixed server/frontend — server lines=721 vs front lines=4 | `a0dc8452a2` |
| 794 | `8a84e32cf6` | #19438 | fix(ai): use @ai-sdk/openai-compatible for third-party providers (#19438) | ACCEPT | 2B-backend |  | `c28de9ae9d` |
| 795 | `85be463487` | #19431 | Slow instance commands (#19431) | ACCEPT | 2B-backend |  | `4dee78e7c0` |
| 796 | `1ae88f4e4f` | #19430 | chore: add CD workflow template and point spawn action to main (#19430) | ACCEPT | 2A-security |  | `afd7a102df` |
| 797 | `265d859c6e` | #19446 | i18n - docs translations (#19446) | ACCEPT | i18n-bulk |  |  |
| 798 | `d07c27a907` | #19432 | [COMMAND MENU ITEMS] Create union type for command menu item payload (#19432) | ACCEPT | 2B-backend | mixed server/frontend — server lines=210 vs front lines=133 | `9357e9f928` |
| 799 | `ac4819758d` | #19451 | i18n - translations (#19451) | ACCEPT | i18n-bulk |  |  |
| 800 | `83917f0dca` | #19447 | Isolate illustrations from sections to style them independently. (#19447) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `d47f5201c4` |
| 801 | `0e0fb246e6` | #19429 | Refactor the website hero into an interactive multi-view illustration (#19429) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `7f340f09a5` |
| 802 | `6cd3f2db2b` | #19449 | chore: replace spawn-twenty-app-dev-test with native postgres/redis services (#19449) | ACCEPT | 2A-security |  | `fb8640fb1a` |
| 803 | `3306d66f5b` | #19445 | cleaning - remove logs (#19445) | ACCEPT | 2B-backend |  | `c93b449e0c` |
| 804 | `31b6dbc583` | #19435 | [COMMAND MENU ITEMS] Remove object metadata name from search commands (#19435) | ACCEPT | 2B-backend |  | `cda747311c` |
| 805 | `bc7b5aee58` | #19454 | chore: centralize deploy/install CD actions in twentyhq/twenty (#19454) | ACCEPT | 2A-security |  | `7286f27212` |
| 806 | `8905d860c7` | #19443 | Store upgrade commands error message (#19443) | ACCEPT | 2B-backend |  | `e208119729` |
| 807 | `4df3539ba1` | #19457 | Fix: Staled data on record table after merging records (#19457) | ACCEPT | 2C-frontend |  | `4c9da65697` |
| 808 | `7d6111b0a5` | #19458 | Fix workspace command name inserted in db (#19458) | ACCEPT | 2B-backend |  | `21e96ea8ac` |
| 809 | `fda3eabb5f` | #19455 | introduce MESSAGING_MESSAGES_GET_BATCH_SIZE as config variable (#19455) | ACCEPT | 2B-backend |  | `d16f32fdef` |
| 810 | `5c867303e0` | #19434 | Fix documentation about importing dates (#19434) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `95c5aef418` |
| 811 | `7aed9291cd` | #19461 | fix(ai-chat): preload web_search action tool when driver is enabled (#19461) | ACCEPT | 2B-backend |  | `a5938f1f11` |
| 812 | `2267c56f15` | #19464 | [COMMAND MENU ITEMS] Disable hide label toggle for items with no short label (#19464) | ACCEPT | 2C-frontend |  | `281c2f1b8e` |
| 813 | `238018dc7b` | #19453 | Reset Tab Page Layout (#19453) | ACCEPT | 2B-backend | mixed server/frontend — server lines=841 vs front lines=744 | `9fa62ca8da` |
...
| 816 | `6073bb6706` | #19427 | Fix AI model registry staleness on self-hosted instances (#19427) | ACCEPT | 2B-backend |  | `aba039ee5f` |
| 817 | `ffb6029c2d` | #19470 | fix(ai-models): use AWS provider chain for Bedrock IRSA auth (#19470) | ACCEPT | 2B-backend |  | `da0c30d6f6` |
| 818 | `c27e3cd1a0` | #19478 | chore: sync AI model catalog from models.dev (#19478) | ACCEPT | 2B-backend |  | `106b5c6bb2` |
| 819 | `91b40b391d` | #19477 | Bump graphql-sse from 2.5.4 to 2.6.0 (#19477) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `7e16316440` |
| 820 | `80337d5c37` | #19476 | Bump tsdav from 2.1.5 to 2.1.8 (#19476) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `2eb1592564` |
| 821 | `1b8f26323a` | #19475 | Bump @babel/preset-react from 7.26.3 to 7.28.5 (#19475) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `60776b2d53` |
| 822 | `f8dff23a3e` | #19480 | Refactor: Extract EventRow shared types and styles to EventRowBase (#19480) | ACCEPT | 2C-frontend |  | `f1d560417a` |
| 823 | `9080180156` | #19456 | [COMMAND MENU ITEMS] Sync object metadata with navigation command menu items (#19456) | ACCEPT | 2B-backend | mixed server/frontend — server lines=557 vs front lines=108 | `66264e2445` |
| 824 | `5edc034f8b` | #19465 | Enqueue a snack bar on merge preview errors (#19465) | ACCEPT | 2C-frontend |  | `dbe53d33c5` |
| 825 | `5eaabe95e7` | #19469 | Fix role synchronisation (#19469) | DEFER | 2D-flags-rbac | RBAC/permissions stack change (wave 2D) | `c613421f3c` |
| 826 | `a78a843419` | #19481 | Fix install and deploy commands (#19481) | ACCEPT | 2B-backend |  | `f7886ca3d5` |
...
| 829 | `9b8cb610c3` | #19491 | Flush Redis between server runs in breaking changes CI (#19491) | ACCEPT | 2A-security |  | `7941099d86` |
| 830 | `19f11b1216` | #19452 | [COMMAND MENU ITEMS] Add dynamic label and icon to command menu navigation items (#19452) | ACCEPT | 2B-backend |  | `7fcbea6284` |
| 831 | `086ea644bb` | #19493 | Resolve frontComponent relation on command menu items via selector (#19493) | ACCEPT | 2C-frontend |  | `3dff00fdd1` |
| 832 | `1577a1933f` | #19483 | Move page layout backfill command out of 1-21 release (#19483) | ACCEPT | 2B-backend |  | `436607bcee` |
| 833 | `7bd84a6029` | #19492 | messaging fix relaunch cron jobs (#19492) | ACCEPT | 2B-backend |  | `4c3a44f15e` |
| 834 | `c76824e69f` | #19497 | i18n - docs translations (#19497) | ACCEPT | i18n-bulk |  |  |
| 835 | `37acd15033` | #19489 | More website fixes. (#19489) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `648fd795fe` |
| 836 | `34972f6167` | #19479 | Record table widget - Follow up (#19479) | ACCEPT | 2C-frontend |  | `c186b4147a` |
| 837 | `1df9942416` | #19500 | i18n - translations (#19500) | ACCEPT | i18n-bulk |  |  |
| 838 | `d495a9f412` | #19482 | reorganize standard page layouts (#19482) | ACCEPT | 2B-backend |  | `89d6641d10` |
| 839 | `1e908e5f0f` | #19484 | fix: SendEmail workflow ConnectedAccount query (#19484) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=191 vs server lines=45 | `970da0c931` |
| 840 | `16e145b036` | #19450 | Fix moving a widget to another tab (#19450) | ACCEPT | 2B-backend | mixed server/frontend — server lines=540 vs front lines=1 | `82e5ed3943` |
| 841 | `5e3cf7cd2b` | #19501 | Prepare 1.21 (#19501) | ACCEPT | 2B-backend |  | `f1a1be0f43` |
| 842 | `74e26ae635` | #19463 | Fix Date/DateTime/Relation field forms (#19463) | ACCEPT | 2C-frontend |  | `b3d19883ed` |
| 843 | `50c5a1a8de` | #19384 | [AI] new model tab design (#19384) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=1235 vs server lines=144 | `3c6cc351e2` |
...
| 846 | `caac791421` | #19498 | Cleaning - Remove logs (#19498) | ACCEPT | 2B-backend |  | `c8abf7f380` |
| 847 | `5116002ca2` | #19503 | chore: replace glb files and lottie with optimized variants (#19503) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `6a6ff399d2` |
...
| 852 | `082822b790` | #19507 | Fix AI chat threads query firing for users without AI permissions (#19507) | ACCEPT | 2C-frontend |  | `559a976532` |
| 853 | `07745947ee` | #19511 | Fix rolesPermissions cache query cartesian product (62k → 162 rows) (#19511) | DEFER | 2D-flags-rbac | RBAC/permissions stack change (wave 2D) | `b5caa90b73` |
| 854 | `e411f076f1` | #19515 | Replace typeorm binary by `database:migrate:generate` (#19515) | ACCEPT | 2B-backend |  | `c48b1f6874` |
| 855 | `00208dbf1f` | #19516 | Build lambda error - catch user code compilation errors (#19516) | ACCEPT | 2B-backend |  | `28543ed0db` |
| 856 | `c54747379a` | #19520 | i18n - translations (#19520) | ACCEPT | i18n-bulk |  |  |
| 857 | `9bea5f73f1` | #19502 | Fix system objects not appearing in sidebar View picker due to filtering mismatch (#19502) | ACCEPT | 2C-frontend |  | `6bdcfc8962` |
| 858 | `77498d2f73` | #19519 | Fix/align microsoft calendar error handling (#19519) | ACCEPT | 2B-backend |  | `d7d17601a5` |
| 859 | `afdd914b83` | #19512 | Add rich-text field widget (#19512) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=329 vs server lines=9 | `3004f2492c` |
| 860 | `8fde5d9da3` | #19521 | i18n - translations (#19521) | ACCEPT | i18n-bulk |  |  |
| 861 | `7ef80dd238` | #19523 | Add standard skills backfill and improve skill availability messaging (#19523) | ACCEPT | 2B-backend |  | `fded1f341a` |
| 862 | `8a10071253` | #19522 | add workspaceId to indirect entities (#19522) | ACCEPT | 2B-backend |  | `94cd0a2cf4` |
| 863 | `e3077691d1` | #19499 | Edit visibility restriction (#19499) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=363 vs server lines=92 | `5b0c50add8` |
| 864 | `df1d0d877d` | #19524 | Flatten AI tool call output structure (#19524) | ACCEPT | 2C-frontend |  | `d75dc070e3` |
| 865 | `7a317b9182` | #19525 | i18n - translations (#19525) | ACCEPT | i18n-bulk |  |  |
| 866 | `d2f51cc939` | #19462 | Fix pre post logic function not executed (#19462) | ACCEPT | 2B-backend |  | `4f0cbabfb4` |
| 867 | `2bb939b4b5` | #19517 | Add file attachment support to agent chat messaging (#19517) | ACCEPT | 2B-backend | mixed server/frontend — server lines=163 vs front lines=9 | `467c48ebc8` |
| 868 | `fb950cf312` | #19527 | i18n - translations (#19527) | ACCEPT | i18n-bulk |  |  |
| 869 | `0fa7beba44` | #19496 | fix mcp streamable-http method handling (#19496) | ACCEPT | 2B-backend |  | `8cd1de6a9d` |
| 870 | `20f28d6593` | #19529 | i18n - docs translations (#19529) | ACCEPT | i18n-bulk |  |  |
| 871 | `4fd721a3c9` | #19533 | chore: sync AI model catalog from models.dev (#19533) | ACCEPT | 2B-backend |  | `a922879629` |
...
| 873 | `cbefd42c4c` | #19528 | Add SSE streaming support on POST /mcp (Phase 2) (#19528) | ACCEPT | 2B-backend |  | `0c38e33a35` |
| 874 | `67e7f05a68` | #19485 | feat: email attachments and open-in-app click action (#19485) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=1114 vs server lines=445 | `ed72e57382` |
| 875 | `f8c35a95b5` | #19537 | i18n - translations (#19537) | ACCEPT | i18n-bulk |  |  |
| 876 | `2ea62317d8` | #19534 | Pre-sync only pre-install-logic-function (#19534) | ACCEPT | 2B-backend |  | `a1dc2db4f2` |
| 877 | `43ce396152` | #19538 | Upgrade cli tool version (#19538) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `017323a612` |
| 878 | `f13e7e01fe` | #19406 | [AI] Add `group_by_*` database tools and centralize groupBy validation (#19406) | ACCEPT | 2B-backend |  | `6788131b58` |
| 879 | `4b3a46d953` | #19508 | Refactor command menu items deprecated code (#19508) | ACCEPT | 2C-frontend |  | `264be837b4` |
| 880 | `63c407e2f7` | #19548 | i18n - translations (#19548) | ACCEPT | i18n-bulk |  |  |
| 881 | `e03ac126ab` | #19539 | halftone generator v1 + new 3d shapes effect start (#19539) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `1b862659af` |
| 882 | `186bc02533` | #19544 | Skip email/calendar tab creation for custom object record page layouts (#19544) | ACCEPT | 2B-backend |  | `708d52d264` |
| 883 | `847e7124d7` | #19541 | Upgrade command internal doc (#19541) | ACCEPT | 2B-backend |  | `c3df4029eb` |
| 884 | `aed81a54a2` | #19542 | Upgrade cli tool version in technical apps (#19542) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a443956f68` |
| 885 | `34a903b4fa` | #19374 | Object icon visual parity (#19374) | ACCEPT | 2C-frontend |  | `accfd7c27c` |
| 886 | `b284c8323c` | #19536 | Remove Favorite and FavoriteFolder from workspace schema (#19536) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=36100 vs server lines=5892 | `d3468766c2` |
| 887 | `ed07afa774` | #19549 |   Workspace export command follow-up (#19549) | ACCEPT | 2B-backend |  | `9c5565d971` |
| 888 | `ec7d19a3af` | #19551 | i18n - translations (#19551) | ACCEPT | i18n-bulk |  |  |
| 889 | `001b7285e6` | #19518 | Support junction relations in Field widget (#19518) | ACCEPT | 2C-frontend |  | `47c221cb28` |
| 890 | `4e6cf185fa` | #19550 | Fix error handling in stream agent chat job (#19550) | ACCEPT | 2B-backend |  | `1fb3cc3396` |
| 891 | `217957f2a1` | #19553 | Optim - Increase connection idle timeout (#19553) | ACCEPT | 2B-backend |  | `36dba6ab2d` |
| 892 | `31baf52528` | #19547 | Workflow - Avoid billing skipped steps (#19547) | ACCEPT | 2B-backend |  | `a4f979097e` |
| 893 | `61720470c5` | #18897 | fix: expand kanban column drop zone to full height (#18897) | ACCEPT | 2C-frontend |  | `14d61b36c0` |
| 894 | `a82d078906` | #19116 | Lambda build update instead of delete existing logic function while building (#19116) | ACCEPT | 2B-backend |  | `da795a23db` |
| 895 | `9a403b84f3` | #19555 | `database:init:prod` triggers instance slow command too (#19555) | ACCEPT | 2B-backend |  | `5678ac969f` |
| 896 | `5a22cc88c5` | #19557 | `database:reset` depends on `database:init` that runs slow instance commands (#19557) | ACCEPT | 2B-backend |  | `4676211e57` |
| 897 | `c99db7d9c6` | #19558 | Fix server-validation ci pending instance command detection (#19558) | ACCEPT | 2A-security |  | `2ed9dc70c4` |
| 898 | `f99c05f0e8` | #19546 | Fix merge command being available in exclusion mode (#19546) | ACCEPT | 2B-backend |  | `12f87af288` |
| 899 | `8c4a6cd663` | #19552 | Replace AGENT_CHAT_UNKNOWN_THREAD_ID with null for thread state (#19552) | ACCEPT | 2C-frontend |  | `f3cc1a3cbf` |
| 900 | `83653a463c` | #19556 | fix: side panel close animation cleanup not firing due to invalid CSS transition (#19556) | ACCEPT | 2C-frontend |  | `a8f7572c71` |
| 901 | `8dd172ba00` | #19505 | Fix: Select next sidebar menu item after removing current item (#19505) | ACCEPT | 2C-frontend |  | `f9a2e75422` |
| 902 | `66d9f92e60` | #19569 | i18n - translations (#19569) | ACCEPT | i18n-bulk |  |  |
| 903 | `65b2baca7a` | #19566 | Remove IS_USAGE_ANALYTICS_ENABLED feature flag (#19566) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `10125c5e52` |
...
| 906 | `0a76db94bc` | #19580 | Bump twenty-sdk, twenty-client-sdk, create-twenty-app to 1.22.0-canary.1 (#19580) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `55454cf1c3` |
| 907 | `300be990b0` | #19573 | halftone v2 (#19573) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `35551e3a7a` |
| 908 | `53065f241f` | #19582 | Exchange clientSecret for tokens after app registration + bump canary (#19582) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `9adb79a460` |
| 909 | `3b55026452` | #19581 | Improve NullCheckEnum filter descriptions with usage examples (#19581) | ACCEPT | 2B-backend |  | `0af980fd10` |
| 910 | `baf2fc4cc9` | #19583 | Fix sdk-e2e-test: ensure DB is ready before server starts (#19583) | ACCEPT | 2A-security |  |  |
| 911 | `4d877d072d` | #19587 | Bump twenty-sdk, twenty-client-sdk, create-twenty-app to 1.22.0-canary.3 (#19587) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `f465ca8ddf` |
| 912 | `b37ef3e7da` | #19589 | Add app-path input to deploy and install composite actions (#19589) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `6a0a829023` |
| 913 | `4c57352450` | #19578 | Improve sensitive config variable masking and editing UX (#19578) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=82 vs server lines=57 | `6511715be9` |
| 914 | `c268a50e4e` | #19591 | i18n - translations (#19591) | ACCEPT | i18n-bulk |  |  |
| 915 | `55b1624210` | #19585 | Convert AI chat state atoms to component family states (#19585) | ACCEPT | 2C-frontend |  | `ece041276d` |
| 916 | `c8f5ecb2b6` | #19600 | Add APPLICATION_LOG_DRIVER=CONSOLE to twenty-app-dev container (#19600) | ACCEPT | 2B-backend |  | `0ff04f6f4f` |
| 917 | `3ae63f0574` | #19599 | Fix syncApplication failing when navigation menu item child is listed before folder in manifest (#19599) | ACCEPT | 2B-backend |  | `1f9c9e4dae` |
| 918 | `6e259d3ded` | #19605 | Inline twenty-shared types in SDK declarations (#19605) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a91503d7eb` |
| 919 | `4264741281` | #19608 | Clear stale SDK config on uninstall and invalid client (#19608) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `2cc3fa46b6` |
| 920 | `fda5aba9ec` | #19603 | small fixes on pricing (#19603) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `ec8177b02f` |
| 921 | `d9d3648baa` | #19598 | Halftone studio v3 (glass effect) (#19598) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `41e5b1c74a` |
| 922 | `ad1a4ecca0` | #19609 | Add isUnique support for application-defined fields (#19609) | ACCEPT | 2B-backend |  | `e41a38e10f` |
| 923 | `7540bb064f` | #19610 | Re-export missing types from SDK public API (#19610) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `35d2b14ee7` |
| 924 | `63806b24fe` | #19611 | Export field settings types from SDK public API (#19611) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a82efb16be` |
| 925 | `9e385e44f9` | #19562 | Fields widget draft view (#19562) | ACCEPT | 2C-frontend |  | `66e1381097` |
| 926 | `4e46aa32bb` | #19612 | i18n - translations (#19612) | ACCEPT | i18n-bulk |  |  |
| 927 | `c73cdd0844` | #19572 | fix: prevent image upload panel from being clipped in side panel (#19572) | ACCEPT | 2C-frontend |  | `40215de892` |
| 928 | `150c326369` | #19613 | fix: prevent image upload panel from being clipped in side panel (#19613) | ACCEPT | 2C-frontend |  | `04b56f3e43` |
| 929 | `09806d7d8c` | #19579 | Add admin panel workspace detail page with chat viewer (#19579) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=1824 vs server lines=1276 | `d2dd3dc3cd` |
| 930 | `de401d96fe` | #19621 | i18n - translations (#19621) | ACCEPT | i18n-bulk |  |  |
| 931 | `7091561489` | #19622 | Fix command `FixMessageThreadViewAndLabelIdentifierCommand` (#19622) | ACCEPT | 2B-backend |  | `80c3e4629d` |
| 932 | `21142d98fe` | #19559 | Implement cross version upgrade (#19559) | ACCEPT | 2B-backend |  | `80d6a760fb` |
| 933 | `63666547fb` | #19639 | Fix e2e (#19639) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `f67dcce24f` |
| 934 | `884b06936e` | #19623 | Switch app test infra to globalSetup with appDevOnce (#19623) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `3aab97f6e4` |
| 935 | `2ac93bd803` | #19628 | Fix design (#19628) | ACCEPT | 2C-frontend |  | `6b03ca5941` |
| 936 | `8bf9b12ace` | #19629 | Fix installed app setting tab (#19629) | ACCEPT | 2C-frontend |  | `27c9d0a541` |
| 937 | `bf5cc68f25` | #19631 | Rename standard and custom apps (#19631) | ACCEPT | 2B-backend | mixed server/frontend — server lines=19 vs front lines=2 | `bd78c65de9` |
| 938 | `cd10f3cbd9` | #19630 | Disable permission tab when empty (#19630) | ACCEPT | 2C-frontend |  | `5a7b077a7c` |
...
| 941 | `6829fc315a` | #19568 | Implement full tab widget frontend (#19568) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=787 vs server lines=6 | `eef54347da` |
| 942 | `6182918a66` | #19641 | Document isAuthRequired: true instead of false (#19641) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `61621724a8` |
| 943 | `5e7e5dd466` | #19637 | Colliding `subject` field fix on `messageThread` command (#19637) | ACCEPT | 2B-backend |  | `1a5a8d1039` |
| 944 | `1382790c80` | #19638 | Fix side panel close button title (#19638) | ACCEPT | 2C-frontend |  | `641464f7f2` |
| 945 | `227d24512e` | #19636 | Fix permission flag deletion validator (#19636) | ACCEPT | 2B-backend |  | `c6f4563642` |
...
| 948 | `87bb2f94bb` | #19625 | Fixes on website (#19625) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `60ec41601f` |
| 949 | `88c0b24d9e` | #19640 | Add per-workspace error handling to CronTriggerCronJob (#19640) | ACCEPT | 2B-backend |  | `cefd9f91ee` |
| 950 | `84b325876d` | #19624 | More website updates. (#19624) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `1448a2e792` |
| 951 | `12233e6c47` | #19648 | few fixes (#19648) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `5876f97e88` |
| 952 | `ce2723d6cf` | #19642 | Move view field label identifier deletion validation into the cross entity validation (#19642) | ACCEPT | 2B-backend |  | `81c8ab1c8a` |
...
| 955 | `7dfc556250` | #19626 | refactor messaging jobs (#19626) | ACCEPT | 2B-backend |  | `ce2afb8619` |
| 956 | `87f5c0083f` | #19627 | Prevent cross version upgrade mismatch in `1.22` (#19627) | ACCEPT | 2B-backend |  | `6310483d61` |
| 957 | `353d1e89d5` | #19633 | Fix merge with null value + reset data virtualization before init load (#19633) | ACCEPT | 2B-backend | mixed server/frontend — server lines=286 vs front lines=28 | `95ee25dc14` |
| 958 | `3f495124a5` | #19619 | Fix navbar folder not opening on page refresh when it has an active child item (#19619) | ACCEPT | 2C-frontend |  | `edd532a576` |
| 959 | `96959b43ba` | #19620 | Fix: Filter out deactivated objects from navigation sidebar (#19620) | ACCEPT | 2C-frontend |  | `9bbc2b699e` |
| 960 | `d2a99ef72d` | #19614 | Fix VariablePicker and Fullscreen Icon overlap in FormAdvancedTextFieldInput (#19614) | ACCEPT | 2C-frontend |  | `b7fba4bc8b` |
| 961 | `123d6241d7` | #19654 | Fix `AddPermissionFlagRoleIdIndexFastInstanceCommand` (#19654) | ACCEPT | 2B-backend |  | `4193280f72` |
| 962 | `fb772c7695` | #19650 | Sync command menu with main context store (#19650) | ACCEPT | 2C-frontend |  | `3148d60c0a` |
| 963 | `76d3e4ad2e` | #19656 | i18n - translations (#19656) | ACCEPT | i18n-bulk |  |  |
| 964 | `64a7725ac7` | #19655 | Add banner for not vetted apps (#19655) | ACCEPT | 2C-frontend |  | `0cf81c7f26` |
| 965 | `665db83bb5` | #19661 | i18n - translations (#19661) | ACCEPT | i18n-bulk |  |  |
| 966 | `0894f2004b` | #19659 | Remove app record if first install fails (#19659) | ACCEPT | 2B-backend |  | `120cc87281` |
| 967 | `fa354b4c1c` | #19660 | Remove orphaned workspaceId column from BillingSubscriptionItemEntity (#19660) | ACCEPT | 2B-backend |  | `44c3eda5e2` |
...
| 969 | `69d228d8a1` | #19662 | Deprecate IS_RECORD_TABLE_WIDGET_ENABLED feature flag (#19662) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `7e9947f8ec` |
...
| 971 | `d88fb2bd65` | #19561 | Clean event creation exception (#19561) | ACCEPT | 2C-frontend |  | `86a8fc267b` |
| 972 | `e041125426` | #19439 | fix: return 404 for deleted workspace webhook race (#19439) | ACCEPT | 2B-backend |  | `c45357a97e` |
| 973 | `87f8e5ca19` | #19663 | few website updates (#19663) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a9354052fa` |
| 974 | `5fa3094800` | #19593 | test: fix failing useColorScheme test and remove FIXME (#19593) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=30 vs server lines=4 | `8257d68b8f` |
| 975 | `194f0963dc` | #19669 | Remove 'twenty-app' keyword by default (#19669) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `6e1fc0e017` |
| 976 | `714f149b0c` | #19670 | Move backfill page layout to `1.23` (#19670) | ACCEPT | 2B-backend |  | `03aadc505e` |
| 977 | `d583984bf0` | #19590 | fix(api-key): batch role resolution with DataLoader to fix N+1 (#19590) | ACCEPT | 2B-backend |  | `ddbdf3c393` |
| 978 | `40c6c63bf5` | #19672 | i18n - docs translations (#19672) | ACCEPT | i18n-bulk |  |  |
| 979 | `49aac04b84` | #19596 | fix: edit button not coming up on avatar right after image upload (#19596) | ACCEPT | 2C-frontend |  | `7fe3ad3e36` |
| 980 | `f738961127` | #19564 | Add gql operationName metadata in sentry (#19564) | ACCEPT | 2B-backend |  | `a5b57635aa` |
| 981 | `3e699c4458` | #19671 | Fix upgrade commands discovery outside of cli (#19671) | ACCEPT | 2B-backend |  | `11ff38ee37` |
| 982 | `eb13378760` | #19635 | Fix Quick Lead command menu item not appearing (#19635) | ACCEPT | 2B-backend |  | `3de9fac308` |
| 983 | `9c07ecd363` | #19567 | Fix view filter/sort deletion (#19567) | ACCEPT | 2C-frontend |  | `547f3b315f` |
| 984 | `b817bdca02` | #19668 | Rpl various fixes (#19668) | ACCEPT | 2C-frontend |  | `947b0e8dd7` |
| 985 | `47bdcb11d8` | #19649 | Move is active to fe (#19649) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=606 vs server lines=314 | `709616bac7` |
| 986 | `edc47bd458` | #19677 | i18n - docs translations (#19677) | ACCEPT | i18n-bulk |  |  |
| 987 | `fb4d037b93` | #19680 | Upgrade self hosting application (#19680) | ACCEPT | 2A-security |  | `59280021aa` |
| 988 | `eaf54ae02f` | #19678 | website new fixes (#19678) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `7093beeff0` |
| 989 | `b194b67ac4` | #19326 | fix(address): populate street line from place details (#19326) | ACCEPT | 2B-backend | mixed server/frontend — server lines=531 vs front lines=56 | `b239ee04da` |
| 990 | `1e42be5a44` | #19684 | Expend field widget field supported types (#19684) | ACCEPT | 2C-frontend |  | `8d57dbb1fa` |
| 991 | `ef328755bb` | #19683 | Bump current version to `1.23.0` (#19683) | ACCEPT | 2B-backend | mixed server/frontend — server lines=217 vs front lines=1 | `29ed538002` |
| 992 | `edba7fe085` | #19682 | Reset to default page layout (#19682) | ACCEPT | 2B-backend | mixed server/frontend — server lines=225 vs front lines=197 | `ab218f1259` |
| 993 | `c8a3de6c65` | #19688 | Test workflow with webhook expected body (#19688) | ACCEPT | 2C-frontend |  | `d147a3f2cf` |
| 994 | `573ecea753` | #19691 | i18n - translations (#19691) | ACCEPT | i18n-bulk |  |  |
| 995 | `762de40c3d` | #19689 | Improve upgrade registry logging for pre-release bundles (#19689) | ACCEPT | 2B-backend |  | `e60d052838` |
| 996 | `b3354ab6e7` | #19685 | Fix multi-workspace-registration (#19685) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=244 vs server lines=9 | `fc1358db4e` |
| 997 | `ed9dd3c275` | #19692 | i18n - translations (#19692) | ACCEPT | i18n-bulk |  |  |
| 998 | `43249d80e8` | #19693 | Add missing doc (#19693) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `8fe1a0dc0b` |
| 999 | `a88d1f4442` | #19675 | Introduce standalone page (#19675) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=1674 vs server lines=1317 | `fb031c0faf` |
| 1000 | `9cf6f42313` | #19699 | i18n - translations (#19699) | ACCEPT | i18n-bulk |  |  |
| 1001 | `3463ee5dc4` | #19697 | Switch default remote to lastly added remote (#19697) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `24a4af4bbc` |
| 1002 | `307b6c94de` | #19690 | Align GraphQL error handling for billing and AI chat (#19690) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=687 vs server lines=279 | `204fe09c1e` |
...
| 1005 | `bc28e1557c` | #19441 | Introduce updateWorkspaceMemberSettings and clarify product (#19441) | DEFER | 2D-flags-rbac | RBAC/permissions stack change (wave 2D) | `fc863e34ee` |
...
| 1009 | `3e48be4c31` | #19711 | Update home card visuals and partner marketing assets (#19711) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a595e93ad0` |
| 1010 | `c805a351ab` | #19702 | Reactivate disabled full tab widgets (#19702) | ACCEPT | 2C-frontend |  | `fe01256bda` |
| 1011 | `f953aea3c5` | #19715 | i18n - translations (#19715) | ACCEPT | i18n-bulk |  |  |
| 1012 | `46ee72160d` | #19714 | Fix infinite recursion in iterator loop traversal when If/Else branch loops back to enclosing iterator (#19714) | ACCEPT | 2B-backend |  | `5f05eebd54` |
| 1013 | `2df32f7003` | #19700 | Hide fallback command menu items in edit mode (#19700) | ACCEPT | 2C-frontend |  | `1cdf310c9a` |
| 1014 | `e12b55a951` | #19696 | Fix duplicate Fields widget (#19696) | ACCEPT | 2B-backend | mixed server/frontend — server lines=607 vs front lines=404 | `30fa72e904` |
| 1015 | `7956ecc7b2` | #19717 | Invert pinned and dots icon buttons in command menu items edit mode (#19717) | ACCEPT | 2C-frontend |  | `bf39bf969e` |
| 1016 | `762fb6fd64` | #19664 | Fix active navigation item disambiguation (#19664) | ACCEPT | 2C-frontend |  | `41130db668` |
...
| 1018 | `94b8e34362` | #19545 | Object view widget - Introduce new TABLE_WIDGET view type (#19545) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=100 vs server lines=36 | `b4813e1a59` |
| 1019 | `0c4a194c7a` | #19720 | i18n - translations (#19720) | ACCEPT | i18n-bulk |  |  |
| 1020 | `8a968d1e31` | #19718 | Hide workflow manual trigger from command menu on "Select All" (#19718) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=21 vs server lines=2 | `2be7e0c401` |
| 1021 | `7601dbc218` | #19722 | i18n - translations (#19722) | ACCEPT | i18n-bulk |  |  |
| 1022 | `7ba5fe32f8` | #19723 | Add new html tags to the remote elements (#19723) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `c47a7bcd65` |
| 1023 | `5e83ad43de` | #19687 | Update backfill page layout command (#19687) | ACCEPT | 2B-backend |  | `316881f45a` |
| 1024 | `8cb803cedf` | #19719 | Various bug fixes Record page layouts (#19719) | ACCEPT | 2C-frontend |  | `8477b90220` |
| 1025 | `a328c127f3` | #19724 | Fix standalone page migration failing on navigationMenuItem enum type change (#19724) | ACCEPT | 2B-backend |  | `fbd822cbf7` |
| 1026 | `0f8152f536` | #19725 | Fix command menu item edit record selection dropdown icons (#19725) | ACCEPT | 2C-frontend |  | `5bcecc833f` |
| 1027 | `a4cc7fb9c5` | #19701 | `[Upgrade]` Fix workspace creation cursor (#19701) | ACCEPT | 2B-backend |  | `9403a60ff9` |
| 1028 | `3b85747d3f` | #19727 | Go back to the original command K button (#19727) | ACCEPT | 2C-frontend |  | `87e4df679a` |
| 1029 | `725171bfd3` | #19729 | i18n - translations (#19729) | ACCEPT | i18n-bulk |  |  |
| 1030 | `56d6e13b5d` | #19726 | Fix fields widget flash during reset (#19726) | ACCEPT | 2C-frontend |  | `b18221942b` |
| 1031 | `b9605a3003` | #19712 | Refactor SnackBar duration handling and progress bar visibility logic (#19712) | ACCEPT | 2C-frontend |  | `37aa457bd0` |
| 1032 | `5eda10760c` | #19686 | Fix navbar folder opening lag by deferring navigation until expand animation completes (#19686) | ACCEPT | 2C-frontend |  | `c74c8c325c` |
| 1033 | `446c39d1c0` | #19698 | Fix silent failures in logic function route trigger execution (#19698) | ACCEPT | 2B-backend |  | `3cd5b521e8` |
| 1034 | `cddc47b61f` | #19731 | i18n - translations (#19731) | ACCEPT | i18n-bulk |  |  |
| 1035 | `da8fe7f6f7` | #19732 | Homepage 3 cards finished (#19732) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `51e558c650` |
| 1036 | `6101a4f113` | #19736 | Update website hero to use shared local avatars and logos (#19736) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `14f13998f4` |
| 1037 | `7adab8884b` | #19746 | Add isUnique update in query + invalidate cache on rollback (#19746) | ACCEPT | 2B-backend | mixed server/frontend — server lines=12 vs front lines=2 | `d1fb23ef8f` |
| 1038 | `e420ee8746` | #19751 | Release v1.22.0 for twenty-sdk, twenty-client-sdk, and create-twenty-app (#19751) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `5a6e9fb602` |
| 1039 | `a49d8386aa` | #19743 | Fix calendar event "Not shared" content alignment and background (#19743) | ACCEPT | 2C-frontend |  | `4c7f7c6cca` |
| 1040 | `7ce3e2b065` | #19742 | Fix spacing between workspace domain cards (#19742) | ACCEPT | 2C-frontend |  | `2c1ba2cfe8` |
| 1041 | `97832af778` | #19747 | [Website] Resolve animations breaking due to renderer context being lost. (#19747) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `f114bbd93d` |
| 1042 | `5583254f58` | #19752 | Remove workspace-migrations deadcode (#19752) | ACCEPT | 2B-backend |  | `b4c178ed20` |
| 1043 | `48c540eb6f` | #19721 | Add event forwarding stories to the front component renderer (#19721) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `271893b008` |
| 1044 | `f5e8c05267` | #19753 | Add logs before and after instance slow data migration (#19753) | ACCEPT | 2B-backend |  | `6905024d49` |
| 1045 | `64470baa1e` | #19749 | fix compute folders to update util (#19749) | ACCEPT | 2B-backend |  | `0418ddbfe1` |
| 1046 | `381f3ba7d9` | #19735 | Fix app design 1/2 (#19735) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=2421 vs server lines=146 | `664029672e` |
| 1047 | `60701c2cf9` | #19754 | i18n - translations (#19754) | ACCEPT | i18n-bulk |  |  |
| 1048 | `d54092b0e2` | #19679 | fix: add missing LayoutRenderingProvider in SettingsApplicationCustomTab (#19679) | ACCEPT | 2C-frontend |  | `1013b1f959` |
| 1049 | `9beb1ca326` | #19734 | Support Select All for workflow manual triggers (#19734) | ACCEPT | 2C-frontend |  | `d512fd0086` |
| 1050 | `7af82fb6a4` | #19758 | i18n - translations (#19758) | ACCEPT | i18n-bulk |  |  |
| 1051 | `2b5b8a8b13` | #19706 | Link command menu items to specific page layout (#19706) | ACCEPT | 2B-backend | mixed server/frontend — server lines=265 vs front lines=110 | `8c88b286a7` |
| 1052 | `2413af0ba9` | #19757 | `[run-instance-commands]` Preserve `fast` `slow` sequentiality (#19757) | ACCEPT | 2B-backend |  | `4d30fdee63` |
| 1053 | `270069c3e3` | #19750 | Add search to Fields dropdown (#19750) | ACCEPT | 2C-frontend |  | `e99649b74c` |
| 1054 | `c0fef0be08` | #19762 | i18n - translations (#19762) | ACCEPT | i18n-bulk |  |  |
| 1055 | `cd31d9e0de` | #19760 | Add test tab to tool step (#19760) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=197 vs server lines=15 | `ae6c17f1a2` |
| 1056 | `9bc803d0c7` | #19765 | i18n - translations (#19765) | ACCEPT | i18n-bulk |  |  |
| 1057 | `cb6953abe3` | #19755 | fix(server): make OAuth discovery and MCP auth metadata host-aware (#19755) | ACCEPT | 2A-security |  | `85a841bdfa` |
| 1058 | `d3df58046c` | #19768 | chore(server): drop api-host branch in OAuth discovery (#19768) | ACCEPT | 2A-security |  | `2091953da0` |
| 1059 | `4103efcb84` | #19771 | fix: replace slow `deep-equal` with `fastDeepEqual` to resolve CPU bottleneck (#19771) | ACCEPT | 2B-backend |  | `c351622824` |
| 1060 | `4f4f723ed0` | #19766 | Fix MCP discovery: path-aware well-known URL and protocol version (#19766) | ACCEPT | 2B-backend |  | `910ac296b9` |
| 1061 | `446a3923f2` | #19764 | Add workspace id in job logs (#19764) | ACCEPT | 2B-backend |  | `36ad3c31b8` |
| 1062 | `aecbc89a3f` | #19770 | Fix slow db query issue (#19770) | ACCEPT | 2B-backend |  | `ceb6646c1b` |
| 1063 | `bf410ae438` | #19584 | `upgrade:status` command (#19584) | ACCEPT | 2B-backend |  | `2d449bfafc` |
| 1064 | `75235f4621` | #19767 | Validate `universalIdentifier` uniqueness among application and its dependencies (#19767) | ACCEPT | 2B-backend |  | `58c7e145fb` |
| 1065 | `d7453303b8` | #19782 | chore: sync AI model catalog from models.dev (#19782) | ACCEPT | 2B-backend |  | `c67a8a500c` |
| 1066 | `fcba0ca30a` | #19763 | Add search to add column dropdown (#19763) | ACCEPT | 2C-frontend |  | `4eeb894990` |
| 1067 | `ba1195d92e` | #19784 | i18n - translations (#19784) | ACCEPT | i18n-bulk |  |  |
| 1068 | `b31f84fbb8` | #19786 | fix(server): workspace member permissions and profile onboarding (#19786) | ACCEPT | 2B-backend |  | `08e1a2b97c` |
| 1069 | `70603a1af6` |  | Fix | ACCEPT | 2C-frontend |  | `585c85704e` |
| 1070 | `7aa60fd20b` |  | Revert "Fix" | ACCEPT | 2C-frontend |  | `1c1ad22ca2` |
| 1071 | `76ea0f37ed` | #19787 | Surface structured validation errors during application install (#19787) | ACCEPT | 2B-backend |  | `688a3ccf45` |
| 1072 | `5cd8b7899d` | #19774 | shouldIncludeRecordPageLayouts deprecation (#19774) | ACCEPT | 2B-backend | mixed server/frontend — server lines=132 vs front lines=5 | `e1ee643f14` |
| 1073 | `beeb8b7406` | #19792 | chore: move pageLayoutWidget.conditionalAvailabilityExpression migration to 1.23 fast instance command (#19792) | ACCEPT | 2B-backend |  | `1e8f39a51a` |
| 1074 | `a93f23a150` | #19794 | Fix AI chat dropzone persisting when dragging file out without dropping (#19794) | ACCEPT | 2C-frontend |  | `55066e616c` |
| 1075 | `bb464b2ffb` | #19783 | Forbid other app role extension (#19783) | DEFER | 2D-flags-rbac | RBAC/permissions stack change (wave 2D) | `9998329420` |
| 1076 | `f94ee2d495` | #19795 | i18n - translations (#19795) | ACCEPT | i18n-bulk |  |  |
| 1077 | `e70269b9d3` | #19796 | Fix: aggregate Calculate not updating in dashboard Table widgets (#19796) | ACCEPT | 2C-frontend |  | `46d831689e` |
| 1078 | `4ed6fcd19e` | #19797 | chore: move TABLE_WIDGET view type migration to 1.23 fast instance command (#19797) | ACCEPT | 2B-backend |  | `cdde49f109` |
| 1079 | `68746e22a0` | #19756 | Send Email Tool: Don't persist message on SMTP only connections (#19756) | ACCEPT | 2B-backend |  | `f8bab57bf4` |
| 1080 | `3268a86f4b` | #19799 | Skip backfill record page layouts for missing standard objects (#19799) | ACCEPT | 2B-backend |  | `97a90736fa` |
| 1081 | `120ced44a9` | #19803 | Fix app design 4 (#19803) | ACCEPT | 2C-frontend |  | `9847d7596a` |
| 1082 | `47a742fd01` | #19805 | i18n - translations (#19805) | ACCEPT | i18n-bulk |  |  |
| 1083 | `0cb50f8a9d` | #19806 | Fix indexFieldMetadata select missing workspaceId (#19806) | ACCEPT | 2B-backend |  | `ddfd89fec2` |
| 1084 | `6095798434` | #19813 | Add SVG export and refine halftone studio controls (#19813) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `1d04b312b6` |
| 1085 | `a18840f3cd` | #19811 | Fix deactivated tabs not visible in new tab action (#19811) | ACCEPT | 2C-frontend |  | `e0f44b93e6` |
| 1086 | `ce2a0bfbe5` | #19812 | fix: socket.io allows an unbounded number of binary attachments (#19812) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `4cf7d62431` |
| 1087 | `619ea13649` | #19804 | Twenty for twenty app (#19804) | ACCEPT | 2A-security |  | `48901669df` |
| 1088 | `df9c4e26b5` | #19814 | Disable reset to default when custom tab or widget (#19814) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=258 vs server lines=3 | `d94fe59e76` |
| 1089 | `b8f8892b67` | #19817 | i18n - translations (#19817) | ACCEPT | i18n-bulk |  |  |
| 1090 | `b320de966c` | #19800 | Add reset page layout in record page layout edit mode tab (#19800) | ACCEPT | 2C-frontend |  | `11717d5102` |
| 1091 | `9307c718cf` | #19816 | Add twenty-managed Docker target with AWS CLI for EKS deployments (#19816) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `db9c98bb5a` |
| 1092 | `4a5702328a` | #19819 | i18n - translations (#19819) | ACCEPT | i18n-bulk |  |  |
| 1093 | `13b32a22b6` | #19818 | Add page layout tab icon picker (#19818) | ACCEPT | 2C-frontend |  | `85e7fee304` |
| 1094 | `38a03abc06` | #19820 | Fix app design 5 (#19820) | ACCEPT | 2C-frontend |  | `1b43e32b2e` |
| 1095 | `ab85946102` | #19821 | i18n - translations (#19821) | ACCEPT | i18n-bulk |  |  |
| 1096 | `59e4ed715a` | #19775 | fix(server): normalize empty composite phone sub-fields to NULL (#19775) | ACCEPT | 2B-backend |  | `ebada4a224` |
| 1097 | `3eeaebb0cc` | #19822 | fix(server): make `workspace:seed:dev --light` actually seed only one workspace (#19822) | ACCEPT | 2B-backend |  | `1253057204` |
| 1098 | `fb5a1988b1` | #19823 | fix(server): log inner errors of WorkspaceMigrationRunnerException in workspace iterator (#19823) | ACCEPT | 2B-backend |  | `712aa76cdc` |
| 1099 | `e878d646ed` | #19826 | chore(server): bump logic-function executor lambda memory to 512MB (#19826) | ACCEPT | 2B-backend |  | `fc1c974bdc` |
| 1100 | `4fa2c400c0` | #19825 | fix(server): skip standard page layout widgets referencing missing field metadatas during 1.23 backfill (#19825) | ACCEPT | 2B-backend |  | `feb98a2cb8` |
| 1101 | `b292a93376` | #19824 | fix(server): honor X-Forwarded-* via configurable trust proxy (#19824) | ACCEPT | 2B-backend |  | `0e3750b8b7` |
| 1102 | `768469f2bd` | #19828 | chore: sync AI model catalog from models.dev (#19828) | ACCEPT | 2B-backend |  | `a17a4d32ce` |
| 1103 | `1d575f0496` | #19829 | fix oauth permission check (#19829) | ACCEPT | 2A-security |  | `f41c6b978f` |
| 1104 | `70a73534c0` | #19830 | perf(server): reuse ESM module cache across warm Lambda invocations of logic functions (#19830) | ACCEPT | 2B-backend |  | `c683e126e8` |
| 1105 | `fd495ee61b` | #19832 | fix(server): deliver user-scoped metadata events only to the owning user (#19832) | ACCEPT | 2B-backend |  | `fe8ce13445` |
| 1106 | `eb1ca1b9ec` | #19834 | perf(sdk): split twenty-sdk barrel into per-purpose subpaths to cut logic-function bundle ~700x (#19834) | ACCEPT | 2B-backend |  | `587540826f` |
| 1107 | `4c94699376` | #19841 | Bump twenty-sdk, twenty-client-sdk, create-twenty-app to 1.23.0-canary.1 (#19841) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `c16e138176` |
| 1108 | `c28c20143b` | #19831 | refactor(server): rename Agent exception to Ai; add THREAD_NOT_FOUND / MESSAGE_NOT_FOUND codes (fixes 500s) (#19831) | ACCEPT | 2B-backend |  | `111a3d9d90` |
| 1109 | `be9616db60` | #19842 | chore: remove draft email feature flag (#19842) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `4f82c9a2d1` |
| 1110 | `1c54e79d6c` | #19843 | i18n - translations (#19843) | ACCEPT | i18n-bulk |  |  |
| 1111 | `53d22a3b70` | #19840 | fix(server): require PKCE code_challenge for public OAuth clients (#19840) | ACCEPT | 2A-security |  | `35d15af87c` |
| 1112 | `3292f1758e` | #19844 | i18n - translations (#19844) | ACCEPT | i18n-bulk |  |  |
| 1113 | `5223c4771d` | #19838 | fix(server): align OAuth discovery metadata with MCP / RFC 9728 spec (#19838) | ACCEPT | 2A-security |  | `908d9a3a7e` |
| 1114 | `1f3defa7b3` | #19836 | fix(server): expose WWW-Authenticate header for browser-based MCP clients (#19836) | ACCEPT | 2B-backend |  | `5cd9637ef6` |
| 1115 | `066003cb04` | #19846 | Hero 2.0 (#19846) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `b8cdf9361e` |
| 1116 | `dbf43d792c` | #19835 | [Website] Fix testimonials shape, diamond direction, and integrate partner application form. (#19835) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `7429aaab3a` |
| 1117 | `1e27c3b621` | #19845 | fix: correct sSOService → ssoService camelCase typo (#19845) | ACCEPT | 2B-backend |  | `96cc25b567` |
| 1118 | `6117a1d6c0` | #19837 | refactor: standardize AI acronym to Ai (PascalCase) across internal identifiers (#19837) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=924 vs server lines=175 | `e052a8b8ba` |
...
| 1121 | `46aedcf133` | #19866 | chore: sync AI model catalog from models.dev (#19866) | ACCEPT | 2B-backend |  | `a8dbdf24c0` |
| 1122 | `0729ad27b7` | #19862 | Partners, customers and more (#19862) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `e0034c7591` |
| 1123 | `42f57db005` | #19858 | fix(server): add registration_client_uri to DCR response for Claude.ai connector (#19858) | ACCEPT | 2B-backend |  | `1e7af07cf5` |
| 1124 | `5dd7eba911` | #19827 | Fix app design 6 (#19827) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=2226 vs server lines=17 | `291b876dda` |
| 1125 | `903ae5cb09` | #19869 | i18n - translations (#19869) | ACCEPT | i18n-bulk |  |  |
| 1126 | `e68842c268` | #19867 | Billing - fixes (#19867) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=416 vs server lines=93 | `af45adb5dc` |
...
| 1129 | `de1e592cd3` | #19875 | fix(front): suppress full-page skeleton inside auth modal (#19875) | ACCEPT | 2C-frontend |  | `0fd330e6e4` |
| 1130 | `fd2288bfff` | #19870 | fix: prototype pollution via parse in nodejs flatted (#19870) | ACCEPT | 2A-security |  | `800c2502c9` |
| 1131 | `f9768d057e` | #19880 | i18n - docs translations (#19880) | ACCEPT | i18n-bulk |  |  |
| 1132 | `5c2a0cf115` | #19878 | fix(front): gate renewToken Apollo logger on IS_DEBUG_MODE (#19878) | ACCEPT | 2C-frontend |  | `9bb7267d10` |
| 1133 | `10c49a49c4` | #19881 | feat(sdk): support viewSorts in app manifests (#19881) | ACCEPT | 2B-backend |  | `5db7093a83` |
| 1134 | `ade55e293f` | #19868 | fix 1.22 upgrade command add-workspace-id-to-indirect-entities (#19868) | ACCEPT | 2B-backend |  | `30c3706b30` |
| 1135 | `c959998111` | #19883 | Bump twenty-sdk, twenty-client-sdk, create-twenty-app to 1.23.0-canary.9 (#19883) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `08ff702e50` |
| 1136 | `9f5688ab13` | #19882 | Redesign why-twenty page with three-section narrative (#19882) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `aa3591c4b1` |
| 1137 | `117909e10a` | #19886 | Billing - Adapt to new unit (#19886) | ACCEPT | 2B-backend | mixed server/frontend — server lines=30 vs front lines=8 | `3c57bc5ad5` |
| 1138 | `4ecde0e161` | #19888 | i18n - translations (#19888) | ACCEPT | i18n-bulk |  |  |
| 1139 | `13c4a71594` | #19884 | fix(ui): make CardPicker hover cover the whole card and align content left (#19884) | ACCEPT | 2C-frontend |  | `481b2356e8` |
| 1140 | `b140f70260` | #19887 | Website - Plan pricing update (#19887) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `2ee0cd3153` |
| 1141 | `27e1caf9cc` | #19891 | Cleanup files that were committed with website PR, but should not be there. (#19891) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `177ea46630` |
| 1142 | `9a95cd02ed` | #19892 | Fix applications query cartesian product causing read timeouts (#19892) | ACCEPT | 2B-backend |  | `fd260bd9c5` |
| 1143 | `6d3ff4c9ce` | #19890 | Translate standard page layouts (#19890) | ACCEPT | 2B-backend | mixed server/frontend — server lines=593 vs front lines=51 | `e54cdde8c6` |
| 1144 | `755f1c92d1` | #19893 | i18n - translations (#19893) | ACCEPT | i18n-bulk |  |  |
| 1145 | `83bc6d1a1b` | #19894 | [Website] Self-host billing migration and some responsiveness fixes. (#19894) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a0e07d3093` |
| 1146 | `13afef5d1d` | #19896 | fix(server): scope loadingMessage wrap/strip to AI-chat callers (#19896) | ACCEPT | 2B-backend |  | `c25e64b4a8` |
| 1147 | `9a963ddeca` | #19901 | feat(infra): add Dockerfile for twenty-website-new (#19901) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `bf4add535e` |
| 1148 | `96fc98e710` | #19897 | Fix Apps UI: replace 'Managed' label with actual app name and unify app icons (#19897) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=807 vs server lines=36 | `1b92d3f9f1` |
| 1149 | `a174aff5c8` | #19902 | fix(infra): copy nx.json and tsconfig.base.json into website-new image (#19902) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `1d58a5179d` |
| 1150 | `57de05ea74` | #19903 | i18n - translations (#19903) | ACCEPT | i18n-bulk |  |  |
| 1151 | `1b469168c8` | #19904 | chore(workflow): temporarily lift credit-cap gate on workflow steps (#19904) | ACCEPT | 2B-backend |  | `00fd40fd94` |
| 1152 | `192a842f57` | #19905 | fix(website-new): pre-resolve wyw-in-js babel presets to absolute paths (#19905) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `391fbbb779` |
| 1153 | `5c58254eb4` | #19898 | Fix activity relation picker (#19898) | ACCEPT | 2C-frontend |  | `98ee8c4cc9` |
| 1154 | `b4f996e0c4` | #19906 | Release v1.23.0 for twenty-sdk, twenty-client-sdk, and create-twenty-app (#19906) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `539990ea5e` |
| 1155 | `41ee6eac7a` | #19907 | chore(server): bump current version to 2.0.0 and add 2.1.0 as next (#19907) | ACCEPT | 2B-backend |  | `831967d4bc` |
| 1156 | `0adaf8aa7b` | #19908 | docs: use twenty-sdk/define subpath in docs and website demo (#19908) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `28c96858ae` |
| 1157 | `dc50dbdb20` | #19909 | i18n - docs translations (#19909) | ACCEPT | i18n-bulk |  |  |
| 1158 | `6ef15713b1` | #19910 | Release v2.0.0 for twenty-sdk, twenty-client-sdk, and create-twenty-app (#19910) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `767a87e6d3` |
| 1159 | `3ee1b528a1` | #19895 | Website last fixes (#19895) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `edda8aa33f` |
| 1160 | `e1c200527d` | #19913 | fix: pricing card cutoff on website (#19913) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `6347e3e281` |
| 1161 | `34e3b1b90b` | #19911 | feat(website-new): add robots.txt, sitemap.xml and legacy redirects (#19911) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `bc221acfea` |
| 1162 | `8d24551e71` | #19912 | fix(settings): force display "Standard" and "Custom" for app chips (#19912) | ACCEPT | 2C-frontend |  | `854f711a3d` |
| 1163 | `4fd80ee470` | #19915 | i18n - translations (#19915) | ACCEPT | i18n-bulk |  |  |
| 1164 | `a8d4039629` | #19914 | chore: sync AI model catalog from models.dev (#19914) | ACCEPT | 2B-backend |  | `59b0f06b18` |
| 1165 | `a1de37e424` | #19872 | Fix Email composer rich text to HTML conversion  (#19872) | ACCEPT | 2B-backend | mixed server/frontend — server lines=114 vs front lines=6 | `8ead322696` |
| 1166 | `5d438bb70c` | #19728 | Docs: restructure navigation, add halftone illustrations, clean up hero images (#19728) | ACCEPT | 2B-backend |  | `ee8609178c` |
| 1167 | `4f88aab57f` | #19917 | chore(website-new): reword FAQ copy on hosting and Organization plan (#19917) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `a18cc6f486` |
| 1168 | `69868a0ab6` | #19919 | docs: remove alpha warning from apps pages except skills & agents (#19919) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `09d0ee2823` |
| 1169 | `30b8663a74` | #19916 | chore: remove IS_AI_ENABLED feature flag (#19916) | DEFER | 2D-flags-rbac | feature-flag enum location/RBAC stack (wave 2D) | `dbd16ef23d` |
| 1170 | `e3d7d0199d` | #19849 | Fix side panel hotkeys breaking when opening records from table (#19849) | ACCEPT | 2C-frontend |  | `a97c7f4e10` |
| 1171 | `071980d511` | #19749 | Revert "fix compute folders to update util (#19749)" (#19921) | ACCEPT | 2B-backend |  | `5e4f8fa925` |
| 1172 | `15938c1fca` | #19923 | Add 2.0.0 release changelog (#19923) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `7f3fcda4f4` |
| 1173 | `cd73088be6` | #19925 | i18n - docs translations (#19925) | ACCEPT | i18n-bulk |  |  |
| 1174 | `a583ee405b` | #19926 | Cross version and upgrade status docs (#19926) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `38b69a9093` |
| 1175 | `1db242d399` | #19918 | Website - small fixes (#19918) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `72a664c601` |
| 1176 | `8cdd2a3319` | #19928 | i18n - docs translations (#19928) | ACCEPT | i18n-bulk |  |  |
| 1177 | `62ea14a072` | #19929 | fix email workflow (#19929) | ACCEPT | 2B-backend |  | `7468ebedbf` |
| 1178 | `65e01400c0` | #19932 | Cross version ci placeholder (#19932) | ACCEPT | 2A-security |  | `a2e16d53ba` |
| 1179 | `44ba7725ae` | #19934 | i18n - docs translations (#19934) | ACCEPT | i18n-bulk |  |  |
| 1180 | `2b399fc94e` | #19920 | [Website] Fix flickering of faq illustration. (#19920) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `8d54ec481d` |
| 1181 | `7947b1b843` | #19930 | Fix self-hosting pricing page design. (#19930) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `3e7aaace9e` |
| 1182 | `61fdb613e6` | #19931 | Reset default app packages command (#19931) | ACCEPT | 2B-backend |  | `332a9e5fd9` |
| 1183 | `8f34a02fea` | #19938 | Import - Fix (#19938) | ACCEPT | 2C-frontend |  | `5314ce6184` |
| 1184 | `8bb98c309a` | #19939 | i18n - docs translations (#19939) | ACCEPT | i18n-bulk |  |  |
| 1185 | `3eabdf302e` | #19936 | Allow closing navbar folder while viewing an active child item (#19936) | ACCEPT | 2C-frontend |  | `6bddf5923b` |
| 1186 | `a7b10b281c` | #19935 | Optimize 3d models (#19935) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `5ca130b55d` |
| 1187 | `a2099d22b5` | #19933 | Optimize website images (#19933) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `049f6630f2` |
| 1188 | `76582dc04a` | #19937 | Export generateDefaultFieldUniversalIdentifier from SDK (#19937) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `07f5eefdc9` |
| 1189 | `66857ca77b` | #19940 | Remove cross version upgrade placeholder (#19940) | ACCEPT | 2A-security |  | `9a8802709c` |
| 1190 | `0aaffe3212` | #19943 | i18n - docs translations (#19943) | ACCEPT | i18n-bulk |  |  |
| 1191 | `f19b3bfd38` | #19759 | Fix left/right arrow keys not working in dropdown search inputs (#19759) | ACCEPT | 2C-frontend |  | `4beaa60514` |
...
| 1200 | `3d164640c8` | #19959 | Remove Product Hunt banner section (#19959) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `3897d90fbf` |
| 1201 | `b77c44fd20` | #19960 | refactor(tool-provider): dedupe descriptor/generator paths (#19960) | ACCEPT | 2B-backend |  | `c9277fe0aa` |
| 1202 | `66a68d8e1c` | #19967 | i18n - docs translations (#19967) | ACCEPT | i18n-bulk |  |  |
| 1203 | `2a5d5b36db` | #19962 | refactor(tool-provider): kill execute_tool's dual dispatch (#19962) | ACCEPT | 2B-backend |  | `b701c1dcea` |
| 1204 | `44309a6fd9` | #19966 | refactor(tool-provider): rename NativeModelToolProvider to NativeToolBinderService (#19966) | ACCEPT | 2B-backend |  | `7bdcacf31e` |
| 1205 | `a486ead39d` | #19968 | fix: restore Try Twenty button text visibility on docs navbar (#19968) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `c7d3c6f789` |
| 1206 | `f018f17133` | #19970 | i18n - docs translations (#19970) | ACCEPT | i18n-bulk |  |  |
| 1207 | `0c929e7903` | #19969 | refactor(tool-provider): rename web_search to exa_web_search, drop XOR toggle (#19969) | ACCEPT | 2B-backend | mixed server/frontend — server lines=112 vs front lines=24 | `85dec04a66` |
| 1208 | `68d509e98d` | #19964 | Update settings application illustrations and app metadata previews (#19964) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=410 vs server lines=6 | `e2fc4df026` |
| 1209 | `789f8aba5d` | #19975 | i18n - translations (#19975) | ACCEPT | i18n-bulk |  |  |
| 1210 | `c2cf3eac50` | #19947 | feat(sdk): confirm authentication method on remote add (#19947) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `8192d4c5a9` |
| 1211 | `b010599000` | #19946 | fix(server): preserve kanban/calendar fields in view manifest sync (#19946) | ACCEPT | 2B-backend |  | `f4f8c5160c` |
| 1212 | `f0a625c3f8` | #19981 | Cleanup application and app registration test util (#19981) | ACCEPT | 2B-backend |  | `9f29127e8b` |
| 1213 | `f34ba6ac12` | #19983 | i18n - docs translations (#19983) | ACCEPT | i18n-bulk |  |  |
| 1214 | `32e0425a65` | #19976 | Docs - Update getting started (#19976) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `3c3f28add3` |
| 1215 | `0696290af4` | #19984 | fix(page-layout): hide deactivated fields from FIELDS widget and layout editor (#19984) | ACCEPT | 2C-frontend |  | `43bc13985f` |
| 1216 | `921a0f01c8` | #19982 | Forbid permissions update cross app role retarget (#19982) | DEFER | 2D-flags-rbac | RBAC/permissions stack change (wave 2D) | `e8644c9d59` |
| 1217 | `f30ef2432f` | #19987 | i18n - translations (#19987) | ACCEPT | i18n-bulk |  |  |
| 1218 | `3ebeb3a3e8` | #19961 | feat(community): add github-connector example app (#19961) | ACCEPT | 2B-backend | other-only paths (no server/front files) — default 2B | `8d3510fa3a` |
| 1219 | `0d996a5629` | #19986 | Resend app improvements (#19986) | ACCEPT | 2A-security |  | `80638dd4bc` |
| 1220 | `876214bc1d` | #19977 | scaffold record page layout + fields view when adding an object (#19977) | ACCEPT | 2B-backend |  | `e657554662` |
| 1221 | `39831338f7` | #19988 | i18n - translations (#19988) | ACCEPT | i18n-bulk |  |  |
| 1222 | `80e8f6d516` | #19997 | chore(deps): bump @blocknote/server-util from 0.47.1 to 0.47.3 (#19997) | ACCEPT | 2C-frontend | mixed server/frontend — front lines=8 vs server lines=2 | `e6b9a4c542` |

---

## Wave 2 Completion — 2026-04-23

| Wave | Attempted | Successful | Skipped | PR |
|---|---:|---:|---:|---|
| 2A security | 23 | 18 | 5 | #15 |
| 2B backend | 231 | 227 | 4 | #17 |
| 2C frontend | 126 | 125 | 1 | #20 |
| 2D flags/RBAC | 16 | 11 | 5 | #22 |
| i18n-bulk | 0 | 0 | 94 | (skipped per founder) |
| **Total** | **396** | **381** | **109** | |

Wave 2 base: `4583bd0af7`
Wave 2 completion SHA on main: `89722b8a15` (PR #23 Apollo activation doc merge; final wave PR was #22 at `41ab68deb4`)
Next sync base: use `origin/main` tip at time of triage.

Per-wave merge commits (for reverse lookup of cherry-pick new SHAs):
- Wave 2A: `5b601fe675` (PR #15)
- Wave 2B: `4295088637` (PR #17)
- Wave 2C: `4ff9803109` (PR #20)
- Wave 2D: `41ab68deb4` (PR #22)

_Four skip categories applied:_
- "Already landed" defers (expected from wave 1 cherry-pick model — 726 rows)
- Empty-commits after conflict resolution (e.g., `2a5b2746c9` absorbed into `0223975bbd` resolution)
- Massive architectural refactors (SDK renames `4ea2e32366` + dependents, ObjectMetadataItem rename, command-menu refactor, admin-panel migration `75848ff8ea`) — re-triage in future waves; see `docs/ops-logs/2026-04-23-wave2a-skipped-followup.md`
- Partner-os dependency conflicts (e.g., DataSourceService removal `f6423f5925`) — defer until partner-os refactors to drop the dependency

_Coverage:_ 381 of 381 expected cherry-picks (100%) located by `cherry picked from commit <old-sha>` trailer on `origin/main`. 109 unmapped rows correspond exactly to the four skip categories above. Zero silent drops.
