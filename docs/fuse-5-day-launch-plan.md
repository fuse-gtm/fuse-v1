...
| `FUSE-904` AI Chat Guardrails (Token + Safety) | 0.50 | Day 3 | Backlog | Chat step/output limits enforced; MCP writes gated and auditable |
| `FUSE-905` Product Cleanup + Branding Baseline | 0.75 | Day 4 | Backlog | Dead references removed from user-facing paths; Fuse branding baseline applied |
| `FUSE-906` Launch Pack (Landing + Demo + Outreach) | 0.50 | Day 5 | Backlog | Landing page draft live, demo recorded, target list and outreach copy ready |
